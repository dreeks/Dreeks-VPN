...
declare -x OVPN_DNS_SERVERS=([0]="193.183.98.66" [1]="5.135.183.146")
...
declare -x OVPN_SERVER=10.8.66.0/24
declare -x OVPN_SERVER_URL=udp://dreeks.xyz:1194
